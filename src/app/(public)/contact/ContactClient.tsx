          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-primary text-white p-8 rounded-2xl shadow-md space-y-6 relative overflow-hidden">
              ...
              <div>
                ...
                <h2 className="text-xl font-bold font-display text-white">{contactInfo.leaderName}</h2>
                <span className="text-xs text-slate-300 font-medium">{contactInfo.leaderRole}</span>
              </div>
              ...
              <div className="space-y-4 text-sm text-slate-300 border-t border-slate-700/80 pt-5">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contactInfo.phone}`} className="font-medium block mt-1 hover:text-amber-400 transition-colors">
                      {contactInfo.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${contactInfo.email}`} className="font-medium block mt-1 hover:text-amber-400 transition-colors">
                      {contactInfo.email}
                    </a>
                  </div>
                </div>
            ...
            {/* Simulated Location Map Container */}
            <div className="bg-white border border-border-gray rounded-2xl p-4 shadow-sm space-y-3">
              ...
              <div className="w-full h-48 bg-slate-100 rounded-lg flex items-center justify-center border border-slate-200/60 relative overflow-hidden">
                <div className="text-center p-4 space-y-1">
                  ...
                  <span className="text-[10px] text-slate-400 font-bold block uppercase font-mono">Registered Office Location</span>

...
import { Heart, ChevronDown, BarChart3, Users, BookOpen, Megaphone, ArrowRight } from "lucide-react";
...
export default function HomePageClient({ programs, stories, metrics }: HomePageClientProps) {
  ...
  return (
    <div className="flex flex-col w-full animate-fade-up bg-white">
      {/* 1. HERO SECTION (Matching Screenshot 1: Fullscreen kids banner, VITAL highlighted in green, frosted text overlay box) */}
      <section 
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8 mt-10">
          {/* Main Title with VITAL in green font */}
          ...
          {/* Frosted Translucent Glass Overlay Box matching Screenshot 1 */}
        ...
        {/* Floating Down Arrow Badge matching Screenshot 1 bottom */}
        <a
          href="#understanding-cause"
      ...
      {/* 2. UNDERSTANDING THE ORPHAN CRISIS / SERVICE PILLARS (Matching Screenshot 2: 3 Mint rounded cards) */}
      <section id="understanding-cause" className="py-20 sm:py-28 bg-[#f4f8f5]" aria-labelledby="understanding-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 3 Pastel Mint Rounded Container Cards matching Screenshot 2 */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            
            {/* CARD 1: Helping Orphans Through Action */}
            <div className="bg-[#e9f2eb] rounded-[2rem] p-8 sm:p-9 border border-emerald-900/5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl font-bold font-display text-slate-800 leading-tight">
                  Helping Orphans Through Action
                </h3>

                {/* Blue SVG Icon Badge matching Screenshot 2 */}
                <div className="w-20 h-20 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center">
              ...
              <Link
                href="/get-involved"
                className="w-full inline-flex items-center justify-center py-3.5 px-6 rounded-full bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-extrabold text-sm shadow-md transition-all"
              >
      ...
      {/* 3. HOW YOU CAN HELP ORPHANED & VULNERABLE CHILDREN (Matching Screenshot 3 layout & service cards) */}
      <section className="py-20 sm:py-28 bg-white" aria-labelledby="help-children-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            {/* Card 1: Large Featured Donate Card (Left 7 Cols) */}
            <div className="lg:col-span-7 bg-white rounded-[2rem] p-8 sm:p-10 border border-slate-200 shadow-sm flex flex-col md:flex-row gap-8 justify-between items-center relative overflow-hidden">
              ...
              {/* Right Side Photo Composition matching Screenshot 3 */}
            ...
            {/* Card 2 & Card 3 Column (Right 5 Cols) */}
            <div className="lg:col-span-5 flex flex-col gap-8 justify-between">
              
              {/* Card 2: Stand with Orphans in Prayer */}
              <div className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-sm space-y-4 hover:shadow-md transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-2 leading-relaxed">
                    <strong className="text-slate-800">Unite in purpose. Transform the world.</strong> If you share our passion, join our dedicated support and prayer team.
                  </p>
                </div>
                <Link
                  href="/get-involved"
              ...
              <div className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-sm space-y-4 hover:shadow-md transition-all flex-1">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-slate-800 uppercase tracking-wider mt-1">
                    Empowered leaders. United impact.
                  </p>
      ...
      {/* 4. ACTIVE PROGRAMS (SQLite Database Query showcase) */}
      <section className="py-20 bg-[#f4f8f5] border-t border-slate-200" aria-labelledby="programs-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

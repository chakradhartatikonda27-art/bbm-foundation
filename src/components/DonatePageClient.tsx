...
import { Heart, CheckCircle, CreditCard, ChevronRight, ChevronLeft, FileText, Printer, AlertTriangle, ShieldCheck } from "lucide-react";
...
export default function DonatePageClient() {
  ...
  return (
    <div className="bg-brand-bg py-16 sm:py-24 animate-fade-up print:py-0 print:bg-white flex-grow flex items-center justify-center min-h-[calc(100vh-200px)]">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {presets.map((p) => (
                    <button
                      ...
                      className={`py-3.5 rounded-2xl text-sm font-bold border transition-all touch-manipulation min-h-[48px] ${
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center justify-between w-full p-4 rounded-xl border text-left transition-all touch-manipulation min-h-[48px] ${
                      purpose === item
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="inline-flex justify-center items-center w-full py-4 rounded-full bg-secondary hover:bg-secondary-hover text-white font-bold text-sm shadow-md transition-colors disabled:opacity-50 min-h-[48px] touch-manipulation"
                >
                  {isProcessing
              ...
              <div className="space-y-6 animate-fade-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 print:hidden">
                  <button
                    type="button"
                    onClick={handlePrint}
                    className="inline-flex justify-center items-center px-5 py-3.5 rounded-full bg-primary hover:bg-slate-800 text-white font-semibold text-xs transition-colors shadow min-h-[44px] touch-manipulation"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex justify-center items-center px-5 py-3.5 rounded-full border border-border-gray hover:bg-slate-50 text-slate-600 font-semibold text-xs transition-colors min-h-[44px] touch-manipulation"
                  >
                    Support Again
                  </button>
                </div>
            ...
            {step > 1 && step < 5 && (
              <div className="flex justify-between items-center pt-4 border-t border-slate-100 print:hidden">
                <button
                  ...
                  disabled={isProcessing}
                  className="inline-flex items-center text-xs font-semibold text-slate-400 hover:text-primary transition-colors focus:outline-none min-h-[44px] px-2 touch-manipulation"
                >
                ...
                {step < 4 && (
                  <button
                    ...
                    disabled={isProcessing}
                    className="inline-flex items-center justify-center px-6 py-3 rounded-full text-xs font-semibold bg-primary hover:bg-slate-800 text-white transition-colors focus:outline-none min-h-[44px] touch-manipulation"
                  >
                    Next

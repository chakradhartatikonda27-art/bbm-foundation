...
import { Heart, Users, Handshake, CheckCircle, AlertTriangle } from "lucide-react";
    ...
    <div className="bg-brand-bg py-16 sm:py-24 animate-fade-up">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-display font-extrabold tracking-tight text-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          <div className="lg:col-span-4 space-y-4">
            <button
              ...
              className={`flex w-full items-start gap-4 p-5 rounded-2xl border transition-all text-left focus:outline-none min-h-[48px] touch-manipulation ${
                activeTab === "volunteer"
            ...
            <div className="bg-slate-900 text-white p-6 rounded-2xl border border-slate-800 space-y-4 shadow-md">
              ...
              <Link
                href="/donate"
                className="inline-flex w-full justify-center items-center px-4 py-3 rounded-full text-xs font-bold bg-amber-600 hover:bg-amber-700 text-white shadow transition-colors min-h-[44px] touch-manipulation"
              >
                Go to Donation Page
          ...
          {/* Form Content panel */}
          <div className="lg:col-span-8 bg-white p-6 sm:p-10 rounded-2xl border border-border-gray shadow-sm">
            {state?.success && (
            ...
            {activeTab === "volunteer" ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <input
                      ...
                      className="bg-brand-bg rounded-lg border border-border-gray px-4 py-3 text-sm focus:outline-none focus:border-secondary h-12"
                    />
                  </div>
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="inline-flex justify-center items-center w-full sm:w-auto px-8 py-3.5 rounded-full bg-primary hover:bg-secondary text-white font-semibold text-sm transition-all shadow hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] touch-manipulation"
                >
